...
TARGET_BOARD_PLATFORM := MT6762               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := A1k     # From ro.product.board
...
BOARD_FLASH_BLOCK_SIZE := 4096                   # Might be different for your chip
